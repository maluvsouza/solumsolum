  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!-- FONT AWESOME (caso ainda não tenha no projeto) -->
        ...
        <form action="login.php" method="POST">
          ...
          <div class="mb-3 senha-box">
            ...
            <div class="input-group input-senha">
              ...
              <span class="toggleSenha" id="toggleSenhaLogin">
    ...
    <div class="modal-content" style="border-radius:18px;">
      ...
      <div class="modal-body">
        ...
        <form class="row g-3" method="POST" action="handlerInsertUsuario.php">
          ...
          <div class="col-md-6 input-senha">
            <label class="form-label">Senha</label>
...
<!-- MOBILE -->
 <!-- <div class="mobile-bottom-nav">
  ...
  <button class="mobile-nav-item" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample" title="Entrar">
