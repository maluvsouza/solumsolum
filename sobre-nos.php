    ...
    <div class="container-sobre">
        <div class="mission-content">
            <div class="mission-text">
                <h2>Nossa Missão</h2>
                <p>O Solum nasceu da necessidade de criar uma ponte entre consumidores conscientes e produtos
                    verdadeiramente sustentáveis. Acreditamos que pequenas escolhas diárias podem gerar grandes
                    transformações ambientais.</p>
                <p>Nosso objetivo é democratizar o acesso a produtos ecológicos, facilitando a vida de quem quer fazer
                    escolhas mais sustentáveis sem abrir mão da qualidade e praticidade.</p>
            ...
            <div class="team-member">
                ...
                <div class="member-info">
                    ...
                    <div class="member-socials">
                        <a href="https://github.com/foxyjisoo"><i class="fab fa-github"></i></a>
...
<div class="onda-sobrenos" style="    width: 100%;
    height: 100%;
    display: block;
