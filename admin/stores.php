...
<div class="d-flex" style="min-height: 100vh;">
    ...
    <nav class="sidebar" style="width: 250px;">
        <div class="sidebar-brand" style="padding: 0 20px 18px 20px; text-align: center;">
            <a href="../dashboard.php"><img src="../assets/logo/logo-solum.png" alt="Solum" style="max-width:160px; display:block; margin:auto;"></a>
        </div>
                            ...
                            <tr>
                                <td>
                                    <?php if (!empty($s['lojLogo'])): ?>
                                        <img src="../<?= $s['lojLogo'] ? 'assets/lojas/' . htmlspecialchars($s['lojLogo']) : 'assets/imagens/placeholder-loja.png' ?>" alt="Logo">
                                    <?php else: ?>
