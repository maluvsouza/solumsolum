...
<div id="favToast" class="fav-toast">Produto adicionado aos favoritos!</div>
  ...
  <div class="banner-container">
    <div class="banner-texto">
      ...
      <div class="banner-botoes">
        ...
        <a href="vender.php" class="btn-secundario">Quero Vender</a>
      </div>
    ...
    <div class="banner-produtos">
      ...
      <?php foreach ($produtos as $produto): ?>
        ...
        <div class="produto-card ativa" data-product-id="<?php echo $produto['proID']; ?>"
          data-category="<?php echo $produto['proCatID']; ?>">

          <img src="<?php echo $produto['proFoto']; ?>" alt="<?php echo htmlspecialchars($produto['proNome']); ?>"
            class="produto-img">
  ...
  <div class="cardIndex">
    ...
    <div class="cardIndexContent">
      ...
      <p class="cardIndexDescription">Promovemos um consumo mais consciente e acessível.
        Nosso objetivo é conectar pessoas a produtos sustentáveis que respeitam o meio ambiente e valorizam pequenos
        produtores.</p>
    </div>
  </div>
  ...
  <div class="cardIndex">
    ...
    <div class="cardIndexContent">
      ...
      <p class="cardIndexDescription">Oferecemos uma seleção de itens ecológicos,
        reutilizáveis e veganos - de cuidados pessoais a utensílios para o dia a dia - todos com impacto reduzido no
        planeta. </p>
    </div>
  </div>
...
<section class="secao-destaque">
  <div class="onda-verde">
    <svg viewBox="0 0 1200 120" preserveAspectRatio="none">
      <path d="M0,40 C150,80 350,0 600,30 C850,60 1050,20 1200,40 L1200,120 L0,120 Z" fill="#3B3B3B"></path>
    </svg>
  </div>
  ...
  <div class="conteudo-destaque">
    ...
    <div class="carrossel-container">
      ...
      <div class="carrossel">
        <?php foreach ($produtos as $produto): ?>
          <div class="card-produto" data-product-id="<?= $produto['proID']; ?>"
            ...
            <div class="card-info">
              <p>
                <?= nl2br(htmlspecialchars(substr($produto['proDescricao'], 0, 35)) . (strlen($produto['proDescricao']) > 100 ? '...' : '')); ?>
              </p>
